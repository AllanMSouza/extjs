Ext.define('AppName.view.relatorios.GridComidasProntaseCongeladas',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.gridComidasProntaseCongeladas',
    id: 'gridComidasProntaseCongeladas',
    
    store: 'relatorios.StoreGridComidasProntaseCongeladas',
