Ext.define('AppName.view.relatorios.GridFrutasOvosVerduras',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.gridFrutasOvosVerduras',
    id: 'gridFrutasOvosVerduras',
    
    store: 'relatorios.StoreGridFrutasOvosVerduras',
