Ext.define('AppName.view.relatorios.GridPadariaeSobremesas',{
    extend: 'Ext.grid.Panel',
    alias: 'widget.gridPadariaeSobremesas',
    id: 'gridPadariaeSobremesas',
    
    store: 'relatorios.StoreGridPadariaeSobremesas',
    layout: 'fit',
    height: 300,
    width: 800,
    autoScroll: true,
